// Matthew Gwynne, 6.8.2011 (Swansea)
...
/*!
  ...
  \module_version Investigations/Cryptography/DataEncryptionStandard/ 0.1.2 (6.8.2011)
  ...
  \par Version history
   ...
   - 0.1.2   : 6.8.2011; initial version number (investigations into full DES up to 5 rounds, and full DES with up to 32 key-bits missing).
